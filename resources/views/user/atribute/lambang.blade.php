            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="details-text-area">
                        <img class="details-main-img" src="{{asset('assets/images/inner-images/sd-1.jp')}}g" alt="image">
                        <h3>Lambang Pramuka Padalarang</h3>
                    ...
                    <div class="sidebar-area pl-20 pt-30">
                        ...
                        <div class="sidebar-card recent-news mt-30">
                            ...
                            <div class="recent-news-card">
                                <a href="blog-details.html"><img src="{{asset('assets/images/inner-images/bds1.jp')}}g"
                                        alt="image"></a>
                                <h5><a href="blog-details.html">Responds To Citizenship Advices</a></h5>
                                <p>1st Sep 2022</p>
                            </div>
                            <div class="recent-news-card">
                                <a href="blog-details.html"><img src="{{asset('assets/images/inner-images/bds2.jp')}}g"
                                        alt="image"></a>
                                <h5><a href="blog-details.html">Housing Advisers Program For Beginner</a></h5>
                                <p>4th Sep 2022</p>
                            </div>
                            <div class="recent-news-card">
                                <a href="blog-details.html"><img src="{{asset('assets/images/inner-images/bds3.jp')}}g"
                                        alt="image"></a>
